...
{
    chip_id[2] = *(__IO uint32_t *)(0X1FFFF7E8); //低字节
    chip_id[1] = *(__IO uint32_t *)(0X1FFFF7EC); //
    chip_id[0] = *(__IO uint32_t *)(0X1FFFF7F0); //高字节

    flash_size = *(uint16_t *)(0x1FFFF7E0);   //芯片flash容量
}
